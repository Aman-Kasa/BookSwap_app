                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Consumer<BookProvider>(
                            builder: (context, bookProvider, child) {
                              List<BookModel> filteredBooks = bookProvider.books.where((book) {
                                ...
                                return Center(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 20),
                                      Text(
                                        _searchQuery.isEmpty ? 'No books available' : 'No books found',
                                        style: TextStyle(
                                          fontSize: 18,
                                          fontWeight: FontWeight.w600,
                                          color: AppTheme.textPrimary,
                                      ...
                                      SizedBox(height: 10),
                                      Text(
                                        _searchQuery.isEmpty ? 'Be the first to add a book!' : 'Try a different search term',
                                        style: TextStyle(
